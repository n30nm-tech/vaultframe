    ...
    <div className="space-y-6">
      ...
      {!selectedItem ? (
        ...
        <section className="grid gap-6 xl:grid-cols-[360px_minmax(0,1fr)]">
          ...
          <div className="space-y-5 rounded-[32px] border border-white/10 bg-surface/80 p-5 shadow-panel sm:p-6 xl:sticky xl:top-24 xl:max-h-[calc(100vh-7rem)] xl:self-start xl:overflow-y-auto">
